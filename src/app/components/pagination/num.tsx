...
const Num = ({ num, active, handleClick }: NumProps) => {
	return (
		<button
			...
			className={`relative w-[50px] aspect-square overflow-hidden text-center font-black text-[hsla(0,0%,100%,0.592)] text-base border-2 border-[hsla(288,81%,79%,0.278)] bg-[hsla(280,42%,58%,0.49)] rounded-full transition-[0.5s] duration-[linear] cursor-pointer
  ...
  ${active && 'text-white shadow-[0px_4px_8px_rgba(0,0,0,0.2)]'}`}
		>
			{num}
		</button>
	);
