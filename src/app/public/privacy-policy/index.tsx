		...
		<Transition>
			<div className={styles.container}>
				...
				<ul>
					...
					<li>
						<p>
							<strong>Application</strong> refers to CustomCADs,
					...
					<li>
						<p>
							...
							refers to CustomCADs, Pop Gruyu St. 27.
						</p>
					</li>
					<li>
						<p>
				...
				<ul>
					<li>
						<p>
							By email:{' '}
							<a href='mailto:customcads2023@gmail.com'>
								customcads2023@gmail.com
							</a>
						</p>
					</li>
					<li>
						<p>
							...
							<a
								href='https://www.customcads.com/contact-us'
								rel='external nofollow noopener'
								target='_blank'
							>
								https://www.customcads.com/contact-us
							</a>
						</p>
					</li>
				</ul>
